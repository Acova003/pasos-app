...
CLIENT_ID = '131807459563-77h6ejafa1to45u71qcng7rtf4nto402.apps.googleusercontent.com'
CLIENT_SECRET = 'pDtaWJCUECzulegITp0uwXJ2'
...
def retrieve_data():
    ...
    fitness_service = discovery.build('fitness', 'v1', http=http)
